...
public class ClStayConstraint extends ClEditOrStayConstraint
{
  ...
  public ClStayConstraint(ISimpleVariable var, ClStrength strength, double weight)
    { super(var,strength,weight); }

  public ClStayConstraint(ISimpleVariable var, ClStrength strength)
    { super(var,strength,1.0); }

  public ClStayConstraint(ISimpleVariable var)
