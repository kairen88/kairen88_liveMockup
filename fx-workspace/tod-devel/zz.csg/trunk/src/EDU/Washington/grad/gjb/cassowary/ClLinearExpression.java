...
public class ClLinearExpression extends CL
{
  ...
  public ClLinearExpression(IVariable clv, double value, double constant)
    {
      if (CL.fGC)
  ...
  public ClLinearExpression(IVariable clv, double value)
    {
      this(clv,value,0.0);
    }

  public ClLinearExpression(IVariable clv)
    {
      this(clv,1,0);
    }
  ...
  protected ClLinearExpression(ClDouble constant, Hashtable terms)
	...
	IVariable clv = (IVariable) e.nextElement();
  ...
  public final ClLinearExpression plus(ISimpleVariable var) 
    throws ExCLNonlinearExpression
    { 
  ...
  public final ClLinearExpression minus(ISimpleVariable var) 
       throws ExCLNonlinearExpression
    { 
      return ((ClLinearExpression) clone()).addVariable(var,-1.0);
    }
  ...
  public final ClLinearExpression addVariable(IVariable v, double c)
  ...
  public final ClLinearExpression addVariable(IVariable v)
  { return addVariable(v,1.0); }


  public final ClLinearExpression setVariable(IVariable v, double c)
    { 
      //assert(c != 0.0);  
      ClDouble coeff = (ClDouble) _terms.get(v);
      if (coeff != null) 
  ...
  public final ClLinearExpression addVariable(IVariable v, double c,
 					IVariable subject, ClTableau solver)
  ...
  public final IVariable anyPivotableVariable() throws ExCLInternalError
    {
      if (isConstant())
	{
  ...
  public final void substituteOut(IVariable var, ClLinearExpression expr, 
 			    IVariable subject, ClTableau solver)
  {
  ...
  public final void changeSubject(IVariable old_subject, IVariable new_subject)
    {
  ...
  public final double newSubject(IVariable subject)
    {
  ...
  //     v1*c1 + v2*c2 + .. + vn*cn + c
  public final double coefficientFor(IVariable var)
    { 
