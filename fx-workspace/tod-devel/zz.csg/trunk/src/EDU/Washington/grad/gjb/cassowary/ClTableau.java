...
class ClTableau extends CL
{
  ...
  public final void noteRemovedVariable(IVariable v, IVariable subject)
    { 
  ...
  public final void noteAddedVariable(IVariable v, IVariable subject)
    { 
  ...
  private final void insertColVar(IVariable param_var, 
                                  IVariable rowvar)
  { 
  ...
  protected final void addRow(IVariable var, ClLinearExpression expr)
    {
  ...
  protected final void removeColumn(IVariable var)
    {
      ...
      if (rows != null) {
        for (Iterator e = rows.elements() ; e.hasNext(); ) {
  ...
  protected final ClLinearExpression removeRow(IVariable var)
  ...
  protected final void substituteOut(IVariable oldVar, ClLinearExpression expr)
    {
      if (fTraceOn) fnenterprint("substituteOut:" + oldVar + ", " + expr);
      if (fTraceOn) traceprint(this.toString());
      
      Set varset = (Set) _columns.get(oldVar); 
      for (Iterator e = varset.elements(); e.hasNext(); ) {
  ...
  protected final boolean columnsHasKey(IVariable subject)
    { 
      return _columns.containsKey(subject);
    }

  protected final ClLinearExpression rowExpression(IVariable v)
    {
