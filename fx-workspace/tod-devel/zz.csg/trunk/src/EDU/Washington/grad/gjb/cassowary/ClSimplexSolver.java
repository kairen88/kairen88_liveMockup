...
public class ClSimplexSolver extends ClTableau
{
  ...
  public final ClSimplexSolver addLowerBound(IVariable v, double lower)
  ...
  // Convenience function for creating a linear inequality constraint
  public final ClSimplexSolver addUpperBound(IVariable v, double upper)
    throws ExCLRequiredFailure, ExCLInternalError
  { 
    ClLinearInequality cn = 
  ...
  public final ClSimplexSolver addBounds(IVariable v,
                                         double lower, double upper)
    throws ExCLRequiredFailure, ExCLInternalError
  { addLowerBound(v,lower); addUpperBound(v,upper); return this; }

  // Add constraint "cn" to the solver
  public synchronized final ClSimplexSolver addConstraint(ClConstraint cn)
       throws ExCLRequiredFailure, ExCLInternalError
  {
  ...
  public final ClSimplexSolver addEditVar(ISimpleVariable v, ClStrength strength)
    throws ExCLInternalError
  {
    try 
      {
  ...
  public final ClSimplexSolver addEditVar(ISimpleVariable v)
    throws ExCLInternalError
  { return addEditVar(v, ClStrength.strong); }

  // Remove the edit constraint previously added for variable v
  public final ClSimplexSolver removeEditVar(ISimpleVariable v)
  ...
  public synchronized final ClSimplexSolver beginEdit()
    throws ExCLInternalError
  {
  ...
  public synchronized final ClSimplexSolver endEdit()
    throws ExCLInternalError
  {
    _assert(_editVarMap.size() > 0,"_editVarMap.size() > 0");
    resolve();
    ...
    try
      {
        for (Enumeration e = _editVarMap.keys(); e.hasMoreElements() ; ) {
          ISimpleVariable v = (ISimpleVariable) e.nextElement();
          ClEditInfo cei = (ClEditInfo) _editVarMap.get(v);
          if (cei.Index() >= n) {
            removeEditVar(v);
          }
  ...
  public final ClSimplexSolver addPointStay(ISimpleVariable vx, 
                                            ISimpleVariable vy, 
                                            double weight)
       throws ExCLRequiredFailure, ExCLInternalError
  { 
  ...
  public final ClSimplexSolver addStay(ISimpleVariable v, 
				 ClStrength strength,
				 double weight)
       throws ExCLRequiredFailure, ExCLInternalError
  { 
  ...
  public synchronized final ClSimplexSolver removeConstraint(ClConstraint cn)
       throws ExCLConstraintNotFound, ExCLInternalError
  {
    ...
    if (eVars != null) {
      for (Iterator e = eVars.elements(); e.hasNext() ; ) {
	IVariable clv = (IVariable) e.next();
    ...
    IVariable marker = (IVariable) _markerVars.remove(cn);
    if (marker == null) {
    ...
    if (rowExpression(marker) == null ) {
      ...
      IVariable exitVar = null;
      double minRatio = 0.0;
      for (Iterator e = col.elements(); e.hasNext() ; ) {
	final IVariable v = (IVariable) e.next();
	if (v.isRestricted() ) {
	...
	if (col.size() == 0) {
	  ...
	  exitVar = (IVariable) col.elements().next();
	}
      }
	...
	for (int i = 0; i < _stayPlusErrorVars.size(); i++) {
      ...
      ClEditConstraint cnEdit = (ClEditConstraint) cn;
      ISimpleVariable clv = cnEdit.variable();
  ...
  public synchronized final void resolve()
    throws ExCLInternalError
  {
  ...
  public final ClSimplexSolver suggestValue(ISimpleVariable v, double x)
    throws ExCLError
  {
  ...
  // values
  public synchronized final ClSimplexSolver solve()
    throws ExCLInternalError
  {
    if (_fNeedsSolving) {
      optimize(_objective);
  ...
  public ClSimplexSolver setEditedValue(ISimpleVariable v, double n)
    throws ExCLInternalError
  {
  ...
  public final boolean FContainsVariable(ISimpleVariable v)
    throws ExCLInternalError
  {
    return columnsHasKey(v) || (rowExpression(v) != null); 
  }
    
  public ClSimplexSolver addVar(ISimpleVariable v)
    throws ExCLInternalError
  {
    if (!FContainsVariable(v)) {
      try {
       ...
       throws ExCLRequiredFailure, ExCLInternalError
  {
	...
	return;
      ...
      IVariable entryVar = e.anyPivotableVariable();
      pivot( entryVar, av);
    }
       ...
       throws ExCLRequiredFailure
  {
    ...
    final IVariable subject = chooseSubject(expr);
    if (subject == null ) {
  ...
  protected final IVariable chooseSubject(ClLinearExpression expr)
       throws ExCLRequiredFailure
  {
    if (fTraceOn) fnenterprint("chooseSubject: " + expr);
    IVariable subject = null; // the current best subject, if any
    ...
    for (Enumeration e = terms.keys(); e.hasMoreElements() ; ) {
      final IVariable v = (IVariable) e.nextElement();
  ...
  protected final void deltaEditConstant(double delta, 
                                         IVariable plusErrorVar, 
                                         IVariable minusErrorVar)
  {
    ...
    for (Iterator e = columnVars.elements(); e.hasNext() ; ) {
      final IVariable basicVar = (IVariable) e.next();
       ...
       throws ExCLInternalError
  {
    ...
    while (!_infeasibleRows.isEmpty()) {
      IVariable exitVar = 
	(IVariable) _infeasibleRows.elements().next();
      _infeasibleRows.remove(exitVar);
      IVariable entryVar = null;
	...
	if (expr.constant() < 0.0) {
	  ...
	  for (Enumeration e = terms.keys(); e.hasMoreElements() ; ) {
	    IVariable v = (IVariable) e.nextElement();
                                                   ...
                                                   ClDouble prevEConstant)
  {
    ...
    for (Enumeration en = cnTerms.keys(); en.hasMoreElements(); ) {
      final IVariable v = (IVariable) en.nextElement();
  ...
  protected final void pivot(IVariable entryVar, 
                             IVariable exitVar)
       throws ExCLInternalError
  {
  ...
  protected final void resetStayConstants()
  {
	...
	rowExpression((IVariable) _stayPlusErrorVars.elementAt(i) );
      if (expr == null )
	expr = rowExpression((IVariable) _stayMinusErrorVars.elementAt(i));
      if (expr != null)
  ...
  protected final void setExternalVariables()
  {
    ...
    System.out.println("ClSimplexSolver.setExternalVariables()");
    
    for (Iterator e = _externalParametricVars.elements(); 
	 e.hasNext() ; ) {
      ISimpleVariable v = (ISimpleVariable) e.next();
    ...
    for (Iterator e = _externalRows.elements(); e.hasNext(); ) {
      ISimpleVariable v = (ISimpleVariable) e.next();
  ...
  protected final void insertErrorVar(ClConstraint cn, IVariable var)
  { 
