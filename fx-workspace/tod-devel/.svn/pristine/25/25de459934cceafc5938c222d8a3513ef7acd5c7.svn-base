...
public class ClLinearInequality extends ClLinearConstraint
{
  ...
  public ClLinearInequality(ISimpleVariable clv1,
			    byte op_enum,
			    ISimpleVariable clv2,
			    ClStrength strength,
			    double weight)
  ...
  public ClLinearInequality(ISimpleVariable clv,
			    byte op_enum,
			    double val,
			    ClStrength strength,
			    double weight)
  ...
  public ClLinearInequality(IVariable clv,
			    byte op_enum,
