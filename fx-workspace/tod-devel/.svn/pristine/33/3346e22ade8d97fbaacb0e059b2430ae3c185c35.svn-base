...
public class ClTests extends CL {
       ...
       throws ExCLInternalError, ExCLRequiredFailure
  {
    ...
    ISimpleVariable x = new ClVariable(167);
    ISimpleVariable y = new ClVariable(2);
  ...
  {
    boolean fOkResult = true;
    ISimpleVariable x = new ClVariable(5);
    ISimpleVariable y = new ClVariable(10);
    ClSimplexSolver solver = new ClSimplexSolver();
  ...
  {
    boolean fOkResult = true; 
    ISimpleVariable x = new ClVariable("x");
    ClSimplexSolver solver = new ClSimplexSolver();
	 ...
	 ExCLConstraintNotFound, ExCLNonlinearExpression
  {
    boolean fOkResult = true; 
    ISimpleVariable x = new ClVariable("x");
    ISimpleVariable y = new ClVariable("y");
    ClSimplexSolver solver = new ClSimplexSolver();
       ...
       throws ExCLInternalError, ExCLRequiredFailure, ExCLError
  {
    try 
      ...
      ISimpleVariable x = new ClVariable("x");
      ISimpleVariable y = new ClVariable("y");
      ISimpleVariable w = new ClVariable("w");
      ISimpleVariable h = new ClVariable("h");
      ClSimplexSolver solver = new ClSimplexSolver();
       ...
       throws ExCLInternalError, ExCLRequiredFailure
  {
    try 
      ...
      ISimpleVariable x = new ClVariable("x");
      ISimpleVariable y = new ClVariable("y");
      ISimpleVariable z = new ClVariable("z");
      ClSimplexSolver solver = new ClSimplexSolver();
	 ...
	 ExCLNonlinearExpression, ExCLConstraintNotFound
  {
    ...
    ISimpleVariable[] rgpclv = new ISimpleVariable[nVars];
