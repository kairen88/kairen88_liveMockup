...
public class JTreeTable extends JTable
{
	...
	public JTreeTable(TreeTableModel aModel)
	{
		this ();
...
//		setIntercellSpacing(new Dimension(0, 0));
	...
	public void setTreeTableModel (TreeTableModel aModel)
	{
		tree.setModel(aModel);
		super.setModel(new TreeTableModelAdapter(aModel, tree));
	}
	 ...
	 */
	public class TreeTableCellEditor extends zz.utils.treetable.AbstractCellEditor implements TableCellEditor
	{
