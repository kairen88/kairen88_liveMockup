...
public class FailsafeLinkedList extends AbstractSequentialList
		        implements List, Cloneable, java.io.Serializable
{
     ...
     */
     public FailsafeLinkedList(Collection c) {
	 this();
	 addAll(c);
     }
	...
	public void remove() {
            try {
                FailsafeLinkedList.this.remove(lastReturned);
...
//	}
     ...
     */
    public Object clone() {
        FailsafeLinkedList clone = null;
	try {
	    clone = (FailsafeLinkedList)super.clone();
